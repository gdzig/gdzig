...
pub const identity = Transform2D.initXAxisYAxisOrigin(.initXY(1, 0), .initXY(0, 1), .initXY(0, 0));
...
pub const flip_x = Transform2D.initXAxisYAxisOrigin(.initXY(-1, 0), .initXY(0, 1), .initXY(0, 0));
...
pub const flip_y = Transform2D.initXAxisYAxisOrigin(.initXY(1, 0), .initXY(0, -1), .initXY(0, 0));
